  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <main className="flex-grow min-h-100 p-3">
        <h2 className="text-[2em] pb-5 pt-5 flex gap-2 items-center">
          <FontAwesomeIcon icon={faTruck} className="text-sky-800" />
          Shipping
        </h2>
        <h3 className="text-[1.5em] pt-3 pb-3">Order Processing Time</h3>
        <p className="text-s bg-stone-100 p-5">
        ...
        <h3 className="text-[1.5em] pt-3 pb-3">
          Shipping Rates &amp; Delivery Estimates
        </h3>
        <p className="text-s bg-stone-100 pl-5">
          Shipping charges for your order will be calculated and displayed at
          checkout.{" "}
        </p>{" "}
        <p className="text-s bg-stone-100 pl-5">Estimated delivery times:</p>
        <ul className="text-s bg-stone-100 pl-5">
        ...
        <h3 className="text-[1.5em] pt-3 pb-3">Order Tracking</h3>
        <p className="text-s bg-stone-100 p-5">
        ...
        <h3 className="text-[1.5em] pt-3 pb-3">Lost or Delayed Packages</h3>
        <p className="text-s bg-stone-100 p-5">
        ...
        <ul className="text-s bg-stone-100 p-5">
          <li>Non-returnable items include:</li>
          <li>Personal care items (e.g., cosmetics, hygiene products)</li>
          <li>Customized or personalized products</li>
        </ul>
        <h3 className="text-[1.5em] pt-3 pb-3">Return Process</h3>
        <ol className="text-s bg-stone-100 p-5">
          <li>
        ...
        <h3 className="text-[1.5em] pt-3 pb-3">Refunds</h3>
        <p className="text-s bg-stone-100 p-5">
        ...
        <p className="text-s bg-stone-100 p-5">
          ...
          don't hesitate to{" "}
          <a href="" className="text-sky-700 font-bold">
            contact us.
          </a>
        </p>
      </main>
